...
import { sessionApi } from '../../../api/TutorSession';

const Home = () => {
  const navigate = useNavigate();
  const { uID } = useParams()
  // Lấy dữ liệu trực tiếp từ file mock, không cần useEffect gọi API
  const [sessions, setSessions] = useState([]);  ///// sửa chỗ này
    ...
    processed.sort((a, b) => {
      switch (sortOption) {
        ...
        case 'duration': 
          ...
          return getNum(b.duration) - getNum(a.duration); // sửa tí
        case 'date': 
    ...
    <div className="h-full font-sans"> 
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5 min-h-[600px]">
        ...
        <div className="flex gap-3 mb-6 relative z-10">
          ...
          <button 
            onClick = {() => navigate('/tutor/'+uID+'/create/')}
...
export default Home; // thêm dòng này